...
public class BottomMenuActivity extends Activity {
	...
	private void initMenu() {
		...
		//第一组
		Integer[] item_drawble = new Integer[] { R.drawable.ic_action_call,
		...
		//第二组
		item_drawble = new Integer[] { R.drawable.ic_action_email,
		...
		//第三组
		item_drawble = new Integer[] { R.drawable.ic_action_refresh,
