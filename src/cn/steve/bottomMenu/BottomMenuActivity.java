...
public class BottomMenuActivity extends Activity {
  ...
  public boolean onMenuOpened(int featureId, Menu menu) {
    ...
    if (myPopupMenu.isShowing()) {
      ...
      /**
       * 这句代码可以使菜单栏如对话框一样弹出的效果 myPopupMenu.setAnimationStyle(android.R.style.Animation_Dialog);
       */
      // 设置菜单栏显示位置
  ...
  private void initMenu() {
    ...
    titles = array2list(new String[] {"常用", "设置", "工具"});
    ...
    Integer[] item_drawble =
        new Integer[] {R.drawable.ic_action_call, R.drawable.ic_action_camera,
    ...
    // 第二组
    item_drawble =
        new Integer[] {R.drawable.ic_action_email, R.drawable.ic_action_full_screen,
    ...
    // 第三组
    item_drawble =
        new Integer[] {R.drawable.ic_action_refresh, R.drawable.ic_action_save,
    ...
    // 第一组
    String[] item_name = new String[] {"电话", "相机", "复制", "裁剪", "剪切", "删除", "下载", "编辑"};
    item_names.add(array2list(item_name));

    item_name = new String[] {"邮件", "全屏", "帮助", "收藏", "地图", "语音", "图片", "定位"};
    item_names.add(array2list(item_name));

    item_name = new String[] {"刷新", "保存", "搜索", "分享", "切换", "录像", "浏览器", "旋转屏幕"};
    item_names.add(array2list(item_name));
