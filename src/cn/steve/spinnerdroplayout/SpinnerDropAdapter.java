...
public class SpinnerDropAdapter extends BaseAdapter {
	...
	public SpinnerDropAdapter(SpinnerDropActivity context) {
		...
		ListItem listItem1 = new ListItem(res, R.string.group_shortcuts, R.drawable.ic_launcher_shortcut, ITEM_SHORTCUT);
		
		ListItem listItem2 = new ListItem(res, R.string.group_widgets, R.drawable.ic_launcher_appwidget, ITEM_APPWIDGET);

		ListItem listItem3 = new ListItem(res, R.string.group_live_folders, R.drawable.ic_launcher_folder_live, ITEM_LIVE_FOLDER);
		
		ListItem listItem4 = new ListItem(res, R.string.group_wallpapers, R.drawable.ic_launcher_gallery, ITEM_WALLPAPER);
