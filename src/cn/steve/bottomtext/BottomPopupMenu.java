...
//		linearLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 200));
...
//		gv_body.setPadding(0, 10, 0, 10);
		...
		gv_body.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,  LayoutParams.MATCH_PARENT));
	...
	public void divisionTran(int position) {
		 ...
		 */
		RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(screenWidth / 7, LayoutParams.MATCH_PARENT);
