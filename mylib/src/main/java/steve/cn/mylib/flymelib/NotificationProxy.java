...
public class NotificationProxy extends Proxy {
    ...
    public static void setProgressBarStype(Builder builder, boolean isCircle) {
        try {
            ...
            sSetProgressBarStype =
                sField.getType().getDeclaredMethod("setCircleProgressBar", boolean.class);
    ...
    public static void setCircleProgressBarColor(int color) {
        try {
            if (sField != null && sObject != null) {
                sSetCircleProgressBarColor =
                    sField.getType().getDeclaredMethod("setCircleProgressBarColor", int.class);
        ...
        try {
            if (sField != null && sObject != null) {
                ssetCircleProgressRimColor =
                    sField.getType().getDeclaredMethod("ssetCircleProgressRimColor", int.class);
