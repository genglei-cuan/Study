 ...
 * 2014-10-16    初始版本创建
 */
package steve.cn.mylib.flymelib;
...
public class ActionBarProxy extends Proxy {
     ...
     * @return boolean 执行结果
     */
    public static boolean SetBackButtonDrawable(ActionBar actionbar,
                                                Drawable backIcon) {
        sSetBackButtonDrawableMethod =
            getMethod(sSetBackButtonDrawableMethod, sClass, "setBackButtonDrawable",
     ...
     * @return boolean 执行结果
     */
    public static boolean SetOverFlowButtonDrawable(ActionBar actionbar,
                                                    Drawable drawable) {
        sSetOverFlowButtonDrawableMethod =
            getMethod(sSetOverFlowButtonDrawableMethod, sClass, "setOverFlowButtonDrawable",
                      new Class[]{Drawable.class});
    ...
    public static boolean setActionModeHeaderHidden(ActionBar bar, boolean hide) {
        sSetActionModeHeaderHiddenMethod =
            getMethod(sSetActionModeHeaderHiddenMethod, sClass, "setActionModeHeaderHidden",
                      boolean.class);
    ...
    public static boolean setActionBarViewCollapsable(ActionBar bar, boolean collapsable) {
        sSetActionBarViewCollapsableMethod =
            getMethod(sSetActionBarViewCollapsableMethod, sClass, "setActionBarViewCollapsable",
                      boolean.class);
        return invoke(sSetActionBarViewCollapsableMethod, bar, collapsable);
    }

    /**
     * <p> 设置ActionBar Tabs显示在底栏，不过需要配合 android:uiOptions="splitActionBarWhenNarrow" <p>
     *
     * @return boolen 执行结果
     */
    public static boolean setActionBarTabsShowAtBottom(
        ActionBar actionbar, boolean showAtBottom) {
        sSetTabsShowAtBottom =
            getMethod(sSetTabsShowAtBottom, sClass, "setTabsShowAtBottom", boolean.class);
