...
/**
 * This implementation of {@link RecyclerView.ItemAnimator} provides basic animations on remove,
 * add, and move events that happen to the items in a RecyclerView.
 *
...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
    ...
    protected ArrayList<RecyclerView.ViewHolder>
        mAddAnimations =
    ...
    protected ArrayList<RecyclerView.ViewHolder>
        mRemoveAnimations =
        new ArrayList<RecyclerView.ViewHolder>();
    private ArrayList<RecyclerView.ViewHolder>
        mPendingRemovals =
        new ArrayList<RecyclerView.ViewHolder>();
    private ArrayList<RecyclerView.ViewHolder>
        mPendingAdditions =
