...
public class JSONUtils {
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getLong(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getLong(String)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getLong(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getInt(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getInt(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getInt(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getDouble(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getDouble(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getDouble(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getString(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getString(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getString(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     * get String from jsonObject
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if keyArray is null or
     * empty, return defaultValue</li> <li>get {@link #getJSONObject(JSONObject, String,
     * JSONObject)} by recursion, return it. if anyone is null, return directly</li> </ul>
     */
     ...
     * get String from jsonData
     *
     * @return <ul> <li>if jsonData is null, return defaultValue</li> <li>if keyArray is null or
     * empty, return defaultValue</li> <li>get {@link #getJSONObject(JSONObject, String,
     * JSONObject)} by recursion, return it. if anyone is null, return directly</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getJSONArray(String)} exception, return
     * defaultValue</li> <li>if {@link JSONArray#getString(int)} exception, return defaultValue</li>
     * <li>return string array</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getStringArray(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getStringList(JSONObject, String, List)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getJSONObject(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getJSONObject(String)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonData is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getJSONObject(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>if {@link JSONObject#getJSONArray(String)} exception, return
     * defaultValue</li> <li>return {@link JSONObject#getJSONArray(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getJSONArray(JSONObject, String, JSONObject)}</li> </ul>
     */
     ...
     *
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if key is null or empty,
     * return defaultValue</li> <li>return {@link JSONObject#getBoolean(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return defaultValue</li> <li>if jsonData {@link
     * JSONObject#JSONObject(String)} exception, return defaultValue</li> <li>return {@link
     * JSONUtils#getBoolean(JSONObject, String, Boolean)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonObject is null, return null</li> <li>return {@link
     * JSONUtils#parseKeyAndValueToMap(String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if jsonData is null, return null</li> <li>if jsonData length is 0, return
     * empty map</li> <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return
     * null</li> <li>return {@link JSONUtils#getMap(JSONObject, String)}</li> </ul>
     */
     ...
     * @return <ul> <li>if sourceObj is null, return null</li> <li>else parse entry by {@link
     * MapUtils#putMapNotEmptyKey(Map, String, String)} one by one</li> </ul>
     */
     ...
     * @return <ul> <li>if source is null or source's length is 0, return empty map</li> <li>if
     * source {@link JSONObject#JSONObject(String)} exception, return null</li> <li>return {@link
     * JSONUtils#parseKeyAndValueToMap(JSONObject)}</li> </ul>
     */
