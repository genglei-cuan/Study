...
/**
 * Array Utils <ul> <li>{@link #isEmpty(Object[])} is null or its length is 0</li> <li>{@link
 * #getLast(Object[], Object, Object, boolean)} get last element of the target element, before the
 * first one that match the target element front to back</li> <li>{@link #getNext(Object[], Object,
 * Object, boolean)} get next element of the target element, after the first one that match the
 * target element front to back</li> <li>{@link #getLast(Object[], Object, boolean)}</li> <li>{@link
 * #getLast(int[], int, int, boolean)}</li> <li>{@link #getLast(long[], long, long, boolean)}</li>
 * <li>{@link #getNext(Object[], Object, boolean)}</li> <li>{@link #getNext(int[], int, int,
 * boolean)}</li> <li>{@link #getNext(long[], long, long, boolean)}</li> </ul>
 *
...
public class ArrayUtils {
     ...
     * front to back <ul> <li>if array is empty, return defaultValue</li> <li>if target element is
     * not exist in array, return defaultValue</li> <li>if target element exist in array and its
     * index is not 0, return the last element</li> <li>if target element exist in array and its
     * index is 0, return the last one in array if isCircle is true, else return defaultValue</li>
     * </ul>
     *
     ...
     * front to back <ul> <li>if array is empty, return defaultValue</li> <li>if target element is
     * not exist in array, return defaultValue</li> <li>if target element exist in array and not the
     * last one in array, return the next element</li> <li>if target element exist in array and the
     * last one in array, return the first one in array if isCircle is true, else return
     * defaultValue</li> </ul>
     *
     * @param value        value of target element
     * @param defaultValue default return value
