...
/**
 * Remove type when cache is full.<br/> when cache is full, compare last used time of object in
 * cache, if time is smaller remove it first.<br/>
 *
