...
/**
 * ImageUtils <ul> convert between Bitmap, byte array, Drawable <li>{@link
 * #bitmapToByte(Bitmap)}</li> <li>{@link #bitmapToDrawable(Bitmap)}</li> <li>{@link
 * #byteToBitmap(byte[])}</li> <li>{@link #byteToDrawable(byte[])}</li> <li>{@link
 * #drawableToBitmap(Drawable)}</li> <li>{@link #drawableToByte(Drawable)}</li> </ul> <ul> get image
 * <li>{@link #getInputStreamFromUrl(String, int)}</li> <li>{@link #getBitmapFromUrl(String,
 * int)}</li> <li>{@link #getDrawableFromUrl(String, int)}</li> </ul> <ul> scale image <li>{@link
 * #scaleImageTo(Bitmap, int, int)}</li> <li>{@link #scaleImage(Bitmap, float, float)}</li> </ul>
 *
