...
public interface ImageSDCardCacheDao {
    ...
    /**
     * put all rows in db whose tag is same to tag to imageSDCardCache <ul>
     * <strong>Attentions:</strong> <li>If imageSDCardCache is null, do nothing</li> <li>If tag is
     * null or empty, do nothing</li> </ul>
     *
     ...
     * imageSDCardCache to db <ul> <strong>Attentions:</strong> <li>If imageSDCardCache is null, do
     * nothing</li> <li>If tag is null or empty, do nothing</li> <li>Will delete all rows in db
     * whose tag is same to tag at first</li> </ul>
     */
