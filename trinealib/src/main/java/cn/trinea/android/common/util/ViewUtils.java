...
/**
 * ViewUtils <ul> <strong>get view height</strong> <li>{@link ViewUtils#getListViewHeightBasedOnChildren(ListView)}</li>
 * <li>{@link ViewUtils#getAbsListViewHeightBasedOnChildren(AbsListView)}</li> </ul> <ul>
 * <strong>set view height</strong> <li>{@link ViewUtils#setViewHeight(View, int)} set view
 * height</li> <li>{@link ViewUtils#setListViewHeightBasedOnChildren(ListView)}</li> <li>{@link
 * ViewUtils#setAbsListViewHeightBasedOnChildren(AbsListView)}</li> </ul> <ul> <strong>get other
 * info</strong> <li>{@link ViewUtils#getGridViewVerticalSpacing(GridView)} get GridView vertical
 * spacing</li> </ul> <ul> <strong>set other info</strong> <li>{@link
 * ViewUtils#setSearchViewOnClickListener(View, OnClickListener)}</li> </ul>
 *
...
public class ViewUtils {
     ...
     * @param includeSubClass Whether returned list will include views which are subclass of filter
     *                        or not.
     */
