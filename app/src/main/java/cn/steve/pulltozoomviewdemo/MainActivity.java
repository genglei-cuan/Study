...
import cn.steve.pulltozoomviewdemo.recyclerview.PullToZoomRecyclerActivity;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pulltozoomdemo);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.pulltozoomviewdemo_main, menu);
        return true;
    }
