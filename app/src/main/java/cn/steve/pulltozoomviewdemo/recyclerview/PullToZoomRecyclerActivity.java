package cn.steve.pulltozoomviewdemo.recyclerview;
...
import cn.steve.pulltozoomviewdemo.PullToZoomRecyclerViewEx;
...
public class PullToZoomRecyclerActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.pulltozoomviewdemo_list_view, menu);
        return true;
    }
