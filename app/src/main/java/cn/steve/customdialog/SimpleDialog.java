        ...
        mButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                NiftyDialogBuilder dialogBuilder = NiftyDialogBuilder
                    .getInstance(SimpleDialog.this);
                // 设置展示的对话框的属性
                dialogBuilder.withTitle("这是对话框的标题").withTitleColor("#FFFFFF")
                    .withDividerColor("#11000000")
                    .withMessage("This is a modal Dialog.").withMessageColor("#FFFFFF")
                    .withIcon(getResources().getDrawable(R.drawable.customer_icon))
                    .isCancelableOnTouchOutside(true).withDuration(700).withEffect(mEffect)
                    .withButton1Text("第一个按钮显示的文字").withButton2Text("第二个按钮显示的文字")
