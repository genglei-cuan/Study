...
/**
 * This sample demonstrates how to use system-provided, automatic layout transitions. Layout transitions are animations that occur when views are added to, removed from, or changed within a {@link
 * ViewGroup}.
 *
...
public class LayoutChangesActivity extends AppCompatActivity {
    ...
    /**
     * The container view which has layout change animations turned on. In this sample, this view is a {@link android.widget.LinearLayout}.
     */
    ...
    private void addItem() {
        ...
        final ViewGroup newView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.layoutchange_item_example, mContainerView, false);
