...
import static cn.steve.progressbar.NumberProgressBar.ProgressTextVisibility.Invisible;
import static cn.steve.progressbar.NumberProgressBar.ProgressTextVisibility.Visible;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            setProgressTextVisibility(bundle
                    .getBoolean(INSTANCE_TEXT_VISIBILITY) ? Visible
                    : Invisible);
