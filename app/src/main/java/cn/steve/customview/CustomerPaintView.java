...
public class CustomerPaintView extends View {
    ...
    private void initialize() {
        ...
        // 设置画笔的类型
        // myPaint.setMaskFilter(new BlurMaskFilter(8,
        // BlurMaskFilter.Blur.NORMAL));
        // myPaint.setMaskFilter(new EmbossMaskFilter(new float[] { 1, 1, 1
        // },0.4f, 6,3.5f));
        // myPaint.setAlpha(50);
        myPath = new Path();
    ...
    private void touch_move(float x, float y) {
        ...
        if (dx >= TOUCH_TOLERANCE || dy >= TOUCH_TOLERANCE) {
            ...
            /**
             * 第一个参数：控制点的x坐标 第二个参数：控制点的y坐标 第三个参数：结束点的x坐标 第四个参数：结束点的y坐标 二次贝塞尔曲线
             */
